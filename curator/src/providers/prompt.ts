...
- Reuse an existing taxonomy path or tag whenever it reasonably fits. Only introduce a new path/tag when nothing existing fits — this is expensive, so prefer reuse.
